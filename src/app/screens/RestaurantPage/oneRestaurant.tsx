...
import { Container, Box, Button, Stack, SliderTrack } from "@mui/material";
        ...
        <Stack flexDirection={"column"} alignItems={"center"}>
          <Stack className={"avatar_big_box"}>
            <Box className={"top_text"}>
              <p>Texes De Brazil Restaurant</p>
            ...
            {Array.from(Array(4).keys()).map((ele, index) => {
              return (
                <Box className={"review_box"} key={index}>
                  ...
                  <span className={"review_name"}>Munisa Singer</span>
                  <span className={"review_prof"}>Foydalanuvchi</span>
                  <p className={"review_desc"}>
                    Menga bu oshxonaning taomi judda yoqdi. Hammaga tavsiya
                    qilaman!!!
                  </p>
                  <div className={"review_stars"}>
                    <StarIcon style={{ color: "#F28057" }} />
                    <StarIcon style={{ color: "#F28057" }} />
                    <StarIcon style={{ color: "#F28057" }} />
      ...
      <Container className="member_reviews">
              ...
              return (
                <Box display={"flex"} flexDirection={"row"} key={index}>
                  ...
                  <div className={"about_right_desc"}>
                    ...
                    <p>
                      Bizning oshpazlarimiz dunyo tanidigan oliygohlarda malaka
                      oshirib kelishgan
                    </p>
                  </div>
                </Box>
        ...
        >
          ...
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21471.346392194013!2d127.31050975435194!3d36.31562070014328!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35654dab0780757b%3A0xb1d86b8ff6c7a9f0!2sKonyang%20University%20hospital!5e0!3m2!1sen!2skr!4v1677433513598!5m2!1sen!2skr"
            width="1320"
            height="500"
